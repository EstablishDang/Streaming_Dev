...
int main(int argc, char** argv)
{
    ...
    else if (argc == 3) // For case decrypt other files
    {
        ...
        memcpy(cOutputFile, argv[2], strlen(argv[2]) - strlen(".fw.pkg"));
        // Output file would be renamed to file removed the .fw.pkg extension
    }
